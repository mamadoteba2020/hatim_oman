...
class account_report_wizard(models.TransientModel):
    ...
    def get_report(self):
        ...
        return self.env.ref('financial_dependents.ohad_all_report').report_action(self, data=data)
...
class ReportAccountingOhad(models.AbstractModel):
    ...
    _name = 'report.financial_dependents.accounting_ohad_all_report_view'
